...
<body>
	<h1 align="center">Tambah Data Penemu</h1>
<table align="center" cellspacing="10" cellpadding="10">
	<form action="" method="POST" enctype="multipart/form-data">
	<tr>
		<td><label for="nomor">Nomor</label></td>
		<td><input type="text" name="nomor" id="nomor" placeholder="Diisi harus berurutan" autofocus autocomplete="off"></td>
	</tr>
	<tr>
		<td><label for="penemu">Nama Penemu</label></td>
		<td><input type="text" name="penemu" id="penemu" placeholder="Masukkan nama penemu" autocomplete="off"></td>
	</tr>
	<tr>
		<td><label for="temuan">Temuan</label></td>
		<td><input type="text" name="temuan" id="temuan" placeholder="Masukkan nama temuan" autocomplete="off"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="tahun_ditemukan" id="tahun_ditemukan" placeholder="Masukkan tahun temuan ditemukan" autocomplete="off"></td>
	</tr>
	<tr>
		<td><label for="gambar_penemu">Foto Penemu</label></td>
		<td><input type="file" name="gambar_penemu" id="gambar_penemu"></td>
	</tr>
	<tr>
